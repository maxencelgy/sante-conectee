...
class _InscriptionWidgetState extends State<InscriptionWidget> {
  ...
  void initState() {
    ...
    _model.emailController ??= TextEditingController(text: 'Prénom et nom');
    _model.passwordController1 ??= TextEditingController(text: 'Email');
    _model.passwordController2 ??= TextEditingController(text: 'Mot de passe');
    _model.passwordController3 ??=
        TextEditingController(text: 'Confirmation de mot de passe');
  }
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.passwordController3Validator
                                .asValidator(context),
                          ),
                        ),
                      ),
